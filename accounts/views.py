...
def edit_profile(request):
    ...
    if request.method == 'POST':
        if 'profile_picture' in request.FILES:
            # This POST came from the "Change photo" form only
            ...
            # This POST came from the main "Edit Profile" form
...
def order_detail(request, order_id):
    order_detail = Order.objects.get(order_number=order_id, user=request.user)
    ordered_products = order_detail.orderproduct_set.all()
